...
export const SearchBar = (props: SearchBarProps) => {
    ...
    }, [inputRef, setInputLength, setInputHeight])
    ...
    return (
        <div>
            ...
            {suggestions.length > 0 && (
                ...
                >
                    {suggestions.slice(0, MAX_SUGGESTIONS).map((t, index) => {
                        return (
                            <div key={t}>
